...
# type Term[S: Symbol] = EmptyTerm | S | Mul[S] | Div[S] | Pow[S] | Invert[S] | Alias[S]
# としたいが Python 3.12?11? 以前では構文がサポートされていないため、Protocol を使って表現する
class _Term(Protocol[S]):
    def __mul__(self, other: _Term[S]) -> Mul[S]: ...
    def __truediv__(self, other: _Term[S]) -> Div[S]: ...
    def __pow__(self, exp: int) -> Pow[S]: ...
    def invert(self) -> _Term[S]: ...
